...
espessura_poros6_200 <- c(19.38, 11.02)
espessura_poros6_4000 <- c(12.87, 10.19)
espessura_poros6_8000 <- c(10.2, 7.06)

a <- 3 # numero de tratamentos (niveis)
n <- length(espessura_poros6_200) # numero de replicas
...
# vetor de resultados
delta <- c(espessura_poros6_200, espessura_poros6_4000, espessura_poros6_8000)
