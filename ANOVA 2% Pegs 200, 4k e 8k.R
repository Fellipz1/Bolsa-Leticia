...
espessura_poros2_200 <- c(19.53, 10.31)
espessura_poros2_4000 <- c(12.27, 10.65)
espessura_poros2_8000 <- c(7.583, 9.6)

a <- 3 # numero de tratamentos (niveis)
n <- length(espessura_poros2_200) # numero de replicas
...
# vetor de resultados
delta <- c(espessura_poros2_200, espessura_poros2_4000, espessura_poros2_8000)
